...
export default function IndexPage() {
  ...
  return (
    <>
      <Head>
        <title>Editor for Hack of Hack Computer of Nand2Tetris on Web</title>
        <meta name="description" content="Editor for Hack of Hack Computer of Nand2Tetris on Web" />
