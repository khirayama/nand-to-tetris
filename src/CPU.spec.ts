...
describe('CPU', function () {
  it('should work correcty with 1010 1010 1010 1010', function () {
    ...
    cpu.write(zero(), b('1010 1010 1010 1010'), 0);
    // inputPins
    assert.deepEqual(cpu.debug.inputPins.inM, b('0000 0000 0000 0000'));
    assert.deepEqual(cpu.debug.inputPins.instruction, b('1010 1010 1010 1010'));
    ...
    assert.deepEqual(cpu.debug.outputPins.pc, b('000 0000 0000 0000'));
    // registers
  ...
  it('should work correcty with 1000 1000 1000 1000', function () {
    ...
    cpu.write(zero(), b('1000 1000 1000 1000'), 0);
    // inputPins
    assert.deepEqual(cpu.debug.inputPins.inM, b('0000 0000 0000 0000'));
    assert.deepEqual(cpu.debug.inputPins.instruction, b('1000 1000 1000 1000'));
    assert.deepEqual(cpu.debug.inputPins.reset, 0);
    // internalPins
    assert.deepEqual(cpu.debug.internalPins.loadD, 0);
    assert.deepEqual(cpu.debug.internalPins.noti15, 0);
  ...
  it('should work correcty with 2 + 3', function () {
    ...
    // assert.deepEqual(cpu.debug.outputPins.outM, b('0000 0000 0000 1000'));
    assert.deepEqual(cpu.debug.outputPins.writeM, 0);
    assert.deepEqual(cpu.debug.outputPins.addressM, b('000 0000 0000 0011'));
    ...
    // assert.deepEqual(cpu.debug.outputPins.writeM, 0);
    // assert.deepEqual(cpu.debug.outputPins.addressM, b('000 0000 0000 0000'));
    // assert.deepEqual(cpu.debug.outputPins.pc, b('000 0000 0000 0101'));
    // // registers
    // assert.deepEqual(cpu.debug.aregister, b('0000 0000 0000 0000'));
    // assert.deepEqual(cpu.debug.dregister, b('0000 0000 0000 0101'));
  ...
  it('should work correcty with 3 + 3', function () {
    ...
    cpu.write(zero(), b('0000 0000 0000 0000'), 0);
    cpu.write(zero(), b('1110 0011 0000 1000'), 0);
    assert.deepEqual(cpu.debug.outputPins.outM, b('0000 0000 0000 0110'));
    assert.deepEqual(cpu.debug.outputPins.writeM, 1);
    assert.deepEqual(cpu.debug.outputPins.addressM, b('000 0000 0000 0000'));
    assert.deepEqual(cpu.debug.outputPins.pc, b('000 0000 0000 0110'));
  });
  ...
  it('should work correcty with 12 + 15', function () {
    ...
    cpu.write(zero(), b('0000 0000 0000 1100'), 0);
    cpu.write(zero(), b('1110 1100 0001 0000'), 0);
    cpu.write(zero(), b('0000 0000 0000 1111'), 0);
    cpu.write(zero(), b('1110 0000 1001 0000'), 0);
    cpu.write(zero(), b('0000 0000 0000 0000'), 0);
    cpu.write(zero(), b('1110 0011 0000 1000'), 0);
    assert.deepEqual(cpu.debug.outputPins.outM, b('0000 0000 0001 1011'));
    assert.deepEqual(cpu.debug.outputPins.writeM, 1);
    assert.deepEqual(cpu.debug.outputPins.addressM, b('000 0000 0000 0000'));
    assert.deepEqual(cpu.debug.outputPins.pc, b('000 0000 0000 0110'));
  });
